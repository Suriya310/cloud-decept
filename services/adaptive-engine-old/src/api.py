...
from adapter import adapt_response, should_adapt
...
async def adapt(request: AdaptRequest):
    ...
    try:
        ...
        strategy = __import__("services.adaptive-engine.src.adapter", fromlist=["ADAPTATION_STRATEGIES"]).ADAPTATION_STRATEGIES.get(
...
async def list_strategies():
    ...
    from adapter import ADAPTATION_STRATEGIES
